...
console.log("API KEY loaded?", Boolean(API_KEY), API_KEY?.slice(0, 6));
...
console.log("Sending message:", userInput);
  ...
  const prompt = `
    ...
    **Your Task:**
    ...
    Use the provided context to give specific, helpful advice.
  ...
  try {
    ...
    return "Hoot! I'm having a little trouble thinking right now. Please try again in a moment. 🦉";
  }
}
