...
function StockCard({ stock, onBuy, onSell, owned = 0, canAfford }) {
  const isUp = stock.trend === 'up';
  const isDown = stock.trend === 'down';
  
  return (
    <div className="stock-card-hover glass-panel p-8 flex flex-col rounded-[2.5rem] border border-white/8">
